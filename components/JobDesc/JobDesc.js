    ...
    <div className={styles.jdWrap}>
      <div className={styles.Description}>
        ...
        <div className={styles.jobDesc}>
          ...
          <p>We're a digital marketing company that prides itself on being different.  We don't rely on a one-size-fits-all approach to marketing – instead, we create bespoke campaigns that are tailored to our clients' individual needs.</p>
          <h3 className={styles.jobHeading}>What makes Pixel Pay Media a great place to work?</h3>
